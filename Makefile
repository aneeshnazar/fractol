...
#    Updated: 2018/01/05 19:27:42 by anazar           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INCDIR = includes/
MLXDIR = minilibx_ec/
FILES = main fractol init_img init_coord init_fractol draw_fractol place_at julia mandelbrot burningship events get_color set_bounds
